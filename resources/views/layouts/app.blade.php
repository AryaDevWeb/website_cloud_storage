        ...
        <div class="flex items-center gap-1 sm:gap-2 ml-auto">
            ...
            <div class="relative" id="user-dropdown-wrapper">
                ...
                <div id="user-dropdown" class="hidden absolute right-0 top-full mt-2 w-56 bg-white rounded-xl border border-gray-200 shadow-lg py-1.5 z-50" role="menu">
                    ...
                    <a href="/admin/users" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-500 hover:text-gray-800 hover:bg-gray-50" role="menuitem">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.5 6a4.5 4.5 0 109 0 4.5 4.5 0 00-9 0zM3 20.25a6.75 6.75 0 0113.5 0M18 18.75a4.5 4.5 0 013 1.1"/></svg>
                        User Access
                    </a>
                    @endif
...
<aside id="sidebar" class="fixed top-16 bottom-0 left-0 z-30 bg-white border-r border-gray-200 flex flex-col w-60 -translate-x-full lg:translate-x-0 transition-all duration-300" role="navigation" aria-label="Sidebar">
    ...
    <div class="px-3 pb-3 border-b border-gray-100">
        <div class="relative" id="sidebar-new-menu-wrapper">
            <button id="sidebar-new-toggle" class="w-full flex items-center justify-center lg:justify-between gap-3 px-3 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl shadow-sm transition-all duration-200" aria-expanded="false" aria-haspopup="true">
...
<div id="context-menu" class="hidden fixed z-[80] min-w-[200px] py-1.5 bg-white rounded-xl border border-gray-100 shadow-xl" role="menu" aria-label="File actions">
    ...
    <div class="my-1 border-t border-gray-100"></div>
    <button data-ctx="restore"   class="ctx-trash-only w-full flex items-center gap-3 px-3 py-2 text-sm text-blue-600 hover:bg-blue-50" role="menuitem"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>Restore</button>
    <button data-ctx="delete"    class="ctx-non-trash w-full flex items-center gap-3 px-3 py-2 text-sm text-red-500 hover:bg-red-50" role="menuitem"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>Delete</button>
    <button data-ctx="perm-delete" class="ctx-trash-only w-full flex items-center gap-3 px-3 py-2 text-sm text-red-600 hover:bg-red-50" role="menuitem"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>Delete Permanently</button>
</div>
...
<div id="bottom-sheet" class="hidden fixed inset-0 z-[80]" aria-modal="true">
    ...
    <div class="absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl border-t border-gray-200 shadow-lg max-h-[70vh] overflow-y-auto">
        ...
        <div class="py-2">
            ...
            <div class="my-1 border-t border-gray-100"></div>
            <button data-bs="restore"     class="bs-trash-only w-full flex items-center gap-4 px-5 py-3 text-sm text-blue-600 hover:bg-blue-50 active:bg-blue-100"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>Restore</button>
            <button data-bs="delete"      class="bs-non-trash w-full flex items-center gap-4 px-5 py-3 text-sm text-red-500 hover:bg-red-50 active:bg-red-100"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>Delete</button>
            <button data-bs="perm-delete" class="bs-trash-only w-full flex items-center gap-4 px-5 py-3 text-sm text-red-600 hover:bg-red-50 active:bg-red-100"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>Delete Permanently</button>
        </div>
    </div>
</div>
