...
@section('title', isset($cari_file) ? 'Rename: ' . $cari_file->file : 'Rename')
        ...
        <div class="bg-[#111827] border border-[#1e293b] rounded-lg p-6">
            <div class="flex items-center gap-3 mb-5">
                ...
                <div>
                    ...
                    <p class="text-xs text-[#94a3b8]">{{ $cari_file->file }}</p>
                </div>
            </div>

            <form action="/rename_sekarang/{{ $cari_file->id }}" class="space-y-4">
                <div>
